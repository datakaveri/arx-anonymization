...
- Supports k-anonymity, entropy-based l-diversity, and equal-distance t-closeness
- Handles numerical and categorical quasi-identifiers
...
```json
{
  ...
  "medical": {
    ...
    "allow_record_suppression": false,
...
- l-diversity to protect against attribute disclosure
- t-closeness to maintain distribution similarity of sensitive values
